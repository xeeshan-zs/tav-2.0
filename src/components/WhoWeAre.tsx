...
function BinaryGrid() {
  const cells = Array.from({ length: 24 }, (_, i) => (
    <motion.div
      ...
      whileInView={{ opacity: [0.08, 0.25, 0.08] }}
      viewport={{ once: false }}
      transition={{
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-14 md:grid-cols-2 md:items-center">
        <Reveal>
          ...
          <motion.h2
            ...
            className="mb-6 font-display text-4xl font-bold leading-[1.15] tracking-tight dark:text-white text-[var(--text-primary)] md:text-5xl"
          >
